...
def create_job_resources(
    ...
    created_resources.append(
        BatchV1Api(api_client).create_namespaced_job(namespace, job_spec)
    )
...
def run_data_prep(namespace: str, release: str):
    ...
    api_responses = create_job_resources(
        ...
        release,
        "data-prep",
        f"bwbble/mg-ref:{bwbble_container_image_version}",
    )
...
def run_index(namespace: str, release: str):
    api_responses = create_job_resources(
        ...
        release,
        "index",
        f"bwbble/mg-aligner:{bwbble_container_image_version}",
